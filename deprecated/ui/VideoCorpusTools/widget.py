...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # Find the push buttons in your UI.
        #self.start_button = self.findChild(QPushButton, "start").clicked.connect(self.start_video)
        self.pause_button = self.findChild(QPushButton, "pause").clicked.connect(self.pause_video)
        self.resume_button = self.findChild(QPushButton, "resume").clicked.connect(self.resume_video)
